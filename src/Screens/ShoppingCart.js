              ...
              {cart_product !== null ? (
                <div className="row">
                  <div className="col-lg-3">
                    <button className="update-cart-btn" onClick={update_cart}>
                      Update Cart
                    </button>
                  </div>
            ...
            <div className="col-lg-4">
              ...
              <div className="total-checkout">
                <h4 className="mt-2 cart-total-txt">
                  Subtotals <span style={{ float: "right" }}>${data}</span>
                </h4>
                <hr />
                <h4 className="mt-4 cart-total-txt2">
                  Totals <span style={{ float: "right" }}>${data}</span>
                </h4>
                <hr />
                ...
                <button className="proceed-btn2 mt-4" onClick={checkout}>
                  Proceed To Checkout
                </button>
              </div>
